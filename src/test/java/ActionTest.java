...
public class ActionTest {
    ...
    public void sendKeysTest() throws InterruptedException {
        ...
        Assert.assertEquals("http://the-internet.herokuapp.com/key_presses", driver.getCurrentUrl());
...
//        source.sendKeys();
    ...
    //TODO Context Menu whit alert window
    @Test
    public void contextMenuNewDLCTest() throws InterruptedException {
        Assert.assertTrue(driver.findElement(By.linkText("Context Menu")).isDisplayed(), "Context Menu");
        driver.findElement(By.linkText("Context Menu")).click();
        Assert.assertEquals("http://the-internet.herokuapp.com/context_menu", driver.getCurrentUrl());
        Actions actions = new Actions(driver);
        WebElement contextBox = driver.findElement(By.id("hot-spot"));
